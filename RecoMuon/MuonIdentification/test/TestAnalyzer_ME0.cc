...
void TestAnalyzer_ME0::beginJob()
{
  ...
  MuonRecoEff_Eta = new TH1F("MuonRecoEff_Eta"      , "Fraction of Real ME0Muons matched to gen muons"   ,40, 2.4, 4.0  );
  MuonRecoEff_Pt = new TH1F("MuonRecoEff_Pt"      , "Fraction of Real ME0Muons matched to gen muons"   ,8, 0,40  );
  ...
  FractionMatched_Eta = new TH1F("FractionMatched_Eta"      , "Fraction of Real ME0Muons that end up successfully matched (matched/all)"   ,40, 2.4, 4.0  );
}
